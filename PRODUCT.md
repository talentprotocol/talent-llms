# Talent Protocol — Product Vision
...
- Net new user signups
- Builder activation rate (% of new users connecting a GitHub account)
...
- B2C: Talent Plus payments
- B2B: Active customers (ecosystems)
...
- **Docs:** [docs.talentprotocol.com](https://docs.talentprotocol.com)
- **API Reference:** [docs.talentprotocol.com/docs/developers/talent-api/api-reference](https://docs.talentprotocol.com/docs/developers/talent-api/api-reference)
- **Brand Assets:** [Notion Brand Guide](https://talentprotocol.notion.site/brand-guide)
- **GitHub:** [github.com/talentprotocol](https://github.com/talentprotocol)
